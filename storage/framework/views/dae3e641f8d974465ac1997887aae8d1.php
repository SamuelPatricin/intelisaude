...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/recuperacaoConta.css')); ?>">
...
<body>
    ...
    <div class="menuRecuperaConta">
        <div class="conteudoRecuperaConta">
            ...
            <form action="<?php echo e(route('recuperacaoConta.enviar')); ?>" method="POST">
...
</html><?php /**PATH C:\xampp\htdocs\inteliSaude\intelisaude\resources\views/recuperacaoConta.blade.php ENDPATH**/ ?>