...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/menuConta.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/autoconsulta.css')); ?>">
...
<body>
    ...
    <div class="conta">
        ...
        <div class="inputNome">
            <h3>Nome: <input type="text" id="inputNome" name="nome" value="<?php echo e($usuario->nome); ?>" readonly> 
            <button type="button" id="editarNome"><svg id="iconeEditar" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <input type="hidden" id="token_csrf" value="<?php echo e(csrf_token()); ?>">
        </div>
        <h3>E-mail: <input type="email" name="email" value="<?php echo e($usuario->email); ?>" readonly></h3>
        
        <p id="mensagemSucesso" style="display: none; position:absolute; top:280px">Nome alterado com sucesso.</p>

        <div class="botoesConta">
            <button onclick="window.location.href = '<?php echo e(url('/atualizarEmail')); ?>';" id="mudarEmail">Alterar e-mail</button> 
            <button onclick="window.location.href = '<?php echo e(url('/atualizarSenha')); ?>';" id="mudarSenha">Alterar senha</button>
            <button onclick="window.location.href = '<?php echo e(url('/apagarUsuario')); ?>';" id="apagarConta">Apagar conta</button>
        </div>
    </div>

    <script src="<?php echo e(asset('js/botaoSuperior.js')); ?>"></script>
    <script src="<?php echo e(asset('js/autoconsulta.js')); ?>"></script>
    <script src="<?php echo e(asset('js/menuConta.js')); ?>"></script>
        <script src="<?php echo e(asset('js/nome.js')); ?>"></script>
</body>

</html><?php /**PATH C:\xampp\htdocs\inteliSaude\intelisaude\resources\views/homePage.blade.php ENDPATH**/ ?>