    ...
    <div class="menuLogin">
        <div class="loginBranco">
            <div class="conteudoBranco">
                ...
                <form action="<?php echo e(route('login.submit')); ?>" method="POST">
                    ...
                    <a href=<?php echo e(url('/recuperacaoConta')); ?>>Esqueceu sua senha?</a>
        ...
        <div class="loginAzul">
            <div class="conteudoAzul">
                ...
                <button onclick="window.location.href = '<?php echo e(url('/')); ?>';">Criar conta</button>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\inteliSaude\intelisaude\resources\views/login.blade.php ENDPATH**/ ?>