    ...
    <div class="menuHomePage">
        <div class="conteudoHomePage" id="conteudoLeitura">
            ...
            <div class="uploadArquivos">
                <label id="uploadDoc" for="fileInput" accept=".pdf,.jpeg,.jpg,.png">
            ...
            <p span id="textoHomePage">Apenas <br><br><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="conta">
        ...
        <div class="inputNome">
            <h3>Nome: <input type="text" id="inputNome" name="nome" value="{{ $usuario->nome }}" readonly>
                <button type="button" id="editarNome"><svg id="iconeEditar" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="botoesConta">
            <button onclick="window.location.href = '{{ url('/atualizarEmail') }}';" id="mudarEmail">Alterar
                e-mail</button>
            <button onclick="window.location.href = '{{ url('/atualizarSenha') }}';" id="mudarSenha">Alterar
                senha</button>
            <button onclick="window.location.href = '{{ url('/apagarUsuario') }}';" id="apagarConta">Apagar
                conta</button>
        </div>
    </div>
